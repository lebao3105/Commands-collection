...
override TARGET_PROGRAMS+=calltime cat chk_type dir env mkdir inp rename rm touch uname
endif
...
ifeq ($(CPU_OS_TARGET),i386-linux)
override TARGET_UNITS+=console logging utils custcustapp sysinf
endif
ifeq ($(CPU_OS_TARGET),i386-go32v2)
override TARGET_UNITS+=console logging utils custcustapp sysinf
endif
...
ifeq ($(CPU_OS_TARGET),i386-linux)
override COMPILER_OPTIONS+=-gl -Sa -Si -Sm -Sc -Sx -dbg:=begin -ded:=end -dretn:=procedure -dfn:=function -dctor:=constructor -ddtor:=destructor
endif
ifeq ($(CPU_OS_TARGET),i386-go32v2)
override COMPILER_OPTIONS+=-gl -Sa -Si -Sm -Sc -Sx -dbg:=begin -ded:=end -dretn:=procedure -dfn:=function -dctor:=constructor -ddtor:=destructor
endif
