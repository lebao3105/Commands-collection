...
override TARGET_PROGRAMS+=calltime cat chk_type dir env mkdir inp rename rm touch
endif
...
ifeq ($(FULL_TARGET),i386-linux)
override TARGET_UNITS+=console logging utils custcustapp
endif
ifeq ($(FULL_TARGET),i386-go32v2)
override TARGET_UNITS+=console logging utils custcustapp
endif
...
ifeq ($(FULL_TARGET),i386-linux)
override COMPILER_OPTIONS+=-Sa -Si -Sm -Sc -dbg:=begin -ded:=end -dretn:=procedure -dfn:=function -dctor:=constructor -ddtor:=destructor
endif
ifeq ($(FULL_TARGET),i386-go32v2)
override COMPILER_OPTIONS+=-Sa -Si -Sm -Sc -dbg:=begin -ded:=end -dretn:=procedure -dfn:=function -dctor:=constructor -ddtor:=destructor
endif
