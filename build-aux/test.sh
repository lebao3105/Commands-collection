...
pushd ../src
mkdir -p ../build/bin/x86_64-linux
fpc $1/$1.pp -gl \
	...
	-Fl../include -FE../build/bin/x86_64-linux

echo "Before running $1, run:"
echo "export LD_LIBRARY_PATH=$(pwd)/$1:\$LD_LIBRARY_PATH"
echo "The program is put in $(pwd)/../build/bin/x86_64-linux"
